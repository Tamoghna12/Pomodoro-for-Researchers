                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className={`px-2 py-0.5 text-xs rounded-full border ${getColorClasses(config.color)}`}>
          ...
          <div className="w-80 bg-gray-50 dark:bg-gray-900 p-6 border-l border-gray-200 dark:border-gray-700">
            {selectedType ? (
              <div className="space-y-6">
                ...
                <button
                  onClick={handleStart}
                  className="w-full p-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium flex items-center justify-center gap-2"
                >
                  Start Session
